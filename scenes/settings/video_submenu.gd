...
@export var shadowtoggle : CheckButton
...
@export var default_SHADOWS : Button

@export_group("Reset Buttons" , "reset_") 
@export var reset_FOV : Button
@export var reset_SHADOWS : Button
...
func _ready() -> void:
	...
	key_button_pairs["SHADOWS"] = [default_SHADOWS, reset_SHADOWS]
...
func get_shadows() ->bool:
	return shadowtoggle.button_pressed
